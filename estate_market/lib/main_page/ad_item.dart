                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("${AppLocalizations.of(context)!.price}: ${ad.property!.price}€"),
                            Text(
                              '${AppLocalizations.of(context)!.address}: ${ad.landmark!.getAddressString()}',
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                            ),
                            Text(
                                '${AppLocalizations.of(context)!.date}: ${DateFormat.yMd(Localizations.localeOf(context).toString()).format(ad.dateOfAd)}'),
                            Text("${AppLocalizations.of(context)!.surface}: ${ad.property!.surface} m²"),
                          ],
                        ),
                      ),
                    ),
